...
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/api/admin/cotizaciones/route": "/api/admin/cotizaciones", "/api/admin/login/route": "/api/admin/login", "/api/admin/modulos/route": "/api/admin/modulos", "/api/admin/productos/route": "/api/admin/productos", "/admin/page": "/admin", "/admin/cotizaciones/page": "/admin/cotizaciones", "/admin/dashboard/page": "/admin/dashboard", "/admin/productos/[id]/page": "/admin/productos/[id]", "/admin/modulos/page": "/admin/modulos", "/admin/productos/nuevo/page": "/admin/productos/nuevo", "/modulo/[id]/page": "/modulo/[id]", "/carrito/page": "/carrito", "/page": "/", "/admin/productos/page": "/admin/productos" };
