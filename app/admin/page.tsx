    ...
    <div className="min-h-screen bg-gradient-to-br from-rosado via-white to-vino/5 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-10">
          ...
          <h1 className="text-3xl font-bold text-negro tracking-tight" style={{ fontFamily: 'var(--font-logo), Montserrat, sans-serif' }}>
            Panel Admin
          </h1>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
          <form onSubmit={handleLogin} className="space-y-5">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full border border-gray-200 rounded-xl pl-12 pr-4 py-3.5 text-negro bg-gray-50 focus:bg-white focus:ring-2 focus:ring-vino focus:border-vino outline-none transition-all"
            ...
            <div>
              <label className="block text-sm font-medium text-negro mb-2">Contraseña</label>
              <div className="relative">
                <div className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400">
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                ...
                <input
                  ...
                  className="w-full border border-gray-200 rounded-xl pl-12 pr-14 py-3.5 text-negro bg-gray-50 focus:bg-white focus:ring-2 focus:ring-vino focus:border-vino outline-none transition-all"
          ...
          <div className="mt-8 pt-6 border-t border-gray-100 text-center space-y-3">
            <a
              ...
              className="flex items-center justify-center gap-2 text-vino hover:text-vino-dark transition-colors font-medium"
            >
            ...
            <Link href="/" className="block text-gray-400 hover:text-negro transition-colors text-sm">
              ← Volver al catálogo
            </Link>
          </div>
        </div>
