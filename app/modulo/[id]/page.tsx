  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <main className="flex-1">
        <div className="relative bg-negro py-14 md:py-20 border-b border-vino/30">
          <div className="absolute inset-0 bg-gradient-to-r from-negro via-gray-900 to-negro" />
      ...
      <footer className="bg-negro text-white py-10 mt-auto border-t border-vino/30">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <div className="w-14 h-14 mx-auto mb-4 rounded-full bg-gradient-to-br from-vino to-vino-dark flex items-center justify-center shadow-lg ring-2 ring-vino/50">
            <span className="text-negro text-xl font-bold">JC</span>
          </div>
          <p className="font-bold text-xl text-vino tracking-wider" style={{ fontFamily: 'var(--font-logo), Montserrat, sans-serif' }}>Joyería Catalina</p>
